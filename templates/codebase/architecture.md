...
Template for `docs/features/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
**State Management:**
- File-based: All state lives in `docs/features/` directory
...
- Examples: `src/commands/new-project.ts`, `src/commands/plan-feature.ts`
- Pattern: Commander.js command registration

**Template:**
- Purpose: Reusable document structures
- Examples: PROJECT.md, FEATURE.md templates
...
- Triggers: User runs `gfd <command>`
