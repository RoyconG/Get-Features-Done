...
Template for `docs/features/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── gfd/           # GFD-specific commands
├── get-features-done/ # Skill resources
...
- Key files: new-project.md, plan-feature.md, execute-plan.md
...
- Purpose: Document templates for docs/features/ files
- Contains: Template definitions with frontmatter
- Key files: project.md, feature.md, summary.md
...
- Key files: execute-plan.md, research-feature.md
- Subdirectories: None
...
**New Slash Command:**
- Primary code: `commands/gfd/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-features-done/templates/{name}.md`
