...
Template for `docs/features/PROJECT.md` — the living project context document.
...
- Format: `- ✓ [Requirement] — [feature-slug]`
...
- Format: `after feature-slug` or `after initial setup`
...
2. Requirements validated? → Move to Validated with feature reference
...
1. **Map codebase first** via `/gfd:map-codebase`
