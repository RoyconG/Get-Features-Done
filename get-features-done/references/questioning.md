...
By the end of questioning, you need enough clarity to write a PROJECT.md that downstream stages can act on:

- **Research** needs: what domain to research, what the user already knows, what unknowns exist
- **Feature creation** needs: clear enough vision to scope v1 features
...
A vague PROJECT.md forces every downstream stage to guess. The cost compounds.
